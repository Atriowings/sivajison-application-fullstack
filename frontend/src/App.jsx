...
import Remainder from './routes/dashboard/Admin Components/Remainder';
...
import CustomerDetails from './routes/dashboard/CustomerDetails';
  ...
  const router = createBrowserRouter([
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/staff/reminder', element: <Remainder /> },
        { path: '/staff/resources', element: <AdminResources /> },
        { path: '/staff/customerdetails', element: <CustomerDetails/> },
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/admin/assigntask', element: <AssignTaskMain /> },
        {
          ...
          children: [
            { index: true, element: <FlightsPage /> },
            { path: '/admin/dataentry/flights', element: <FlightsPage /> },
            { path: '/admin/dataentry/hotels', element: <HotelsPage /> },
            { path: '/admin/dataentry/other', element: <Others /> }, // Fixed typo (HotelsPage)
          ],
        },
        ...
        { path: '/admin/reminder', element: <Remainder /> },
        { path: '/admin/customerdetails', element: <CustomerDetails/> },

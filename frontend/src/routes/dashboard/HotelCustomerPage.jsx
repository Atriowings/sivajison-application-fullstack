...
const HotelCustomerPage = () => {
  ...
  const { toPDF, targetRef } = usePDF({
    ...
    //newly added Helper function to format passenger names
              ...
              <div className="rounded-lg p-6 bg-white dark:bg-gray-800 shadow-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <DetailItem label="Booking ID" value={selectedDetail.bookingid} highlight />
                   {/* newly added */}
                  <DetailItem label="Family Members" value={selectedDetail.passengername} highlight formatFn={formatPassengerNames} />

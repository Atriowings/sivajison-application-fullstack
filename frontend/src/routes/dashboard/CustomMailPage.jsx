...
const CustomMailPage = () => {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      ...
      // Prepare the request data - preserve line breaks by converting to HTML or keeping as text
      const mailPayload = {
        subject: mailData.subject,
        content: mailData.content.replace(/\n/g, '<br>'), // Convert line breaks to HTML <br> tags
        // or use this if your backend handles plain text with line breaks:
  ...
  onChange={handleMailChange}
  rows="8"
  className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-600 dark:focus:border-blue-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white whitespace-pre-wrap"
